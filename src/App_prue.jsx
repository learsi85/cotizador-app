...
<head>
    ...
    <style>
        ...
        .totales {width: 100%; max-width: 400px; margin-left: auto; margin-top: 10px;}
        ...
        /* Modo impresión */
        @media print { body { background: white; } .cotizacion { width: 100%; border: none; margin: 0; padding: 0;} header {flex-wrap: nowrap;}}
        /* Responsivo */
  ...
  <div class="cotizacion">
    <header>
      ...
      <div class="empresa">
        ...
        ${configEmpresa.sitioWeb ? `<p>${configEmpresa.sitioWeb}</p>` : ''}
      </div>
    </header>
    ...
    <section class="datos-cliente">
      ...
      <p><strong>Válida por:</strong> ${configEmpresa.vigenciaCotizacion}</p>
    </section>
    ...
    <div class="totales">
      <table>
        ...
        <tr>
          <td>IVA (16%):</td>
          <td>$ ${parseFloat(cot.total * 0.16).toLocaleString('es-MX', {minimumFractionDigits: 2})}</td>
        </tr>
        <tr class="total-final">
          <td>Total:</td>
          <td>$ ${parseFloat(cot.total * 0.16 + cot.total).toLocaleString('es-MX', {minimumFractionDigits: 2})}</td>
        </tr>
      </table>
    </div>
